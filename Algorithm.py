...
class Algorithm:    
    ...
    # Hàm tìm tầm nhìn tại vị trí hiện tại
    ...
    # Hàm tính tầm nhìn của ô priority 
    ...
    # Hàm tìm đường đi sao cho có tầm nhìn các ô priority là lớn nhất
    ...
    # Hàm heuristic khoảng cách giữa 2 ô
    ...
    # Hàm A* tìm đường đi ngắn nhất giữa 2 ô 
    ...
    # Hàm liệt kê các ô xung quanh announce       
    ...
    # Hàm tạo ra grid có các vị trí ưu tiên
    ...
    # Hàm tìm các đường đi cho hider
