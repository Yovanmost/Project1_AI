...
class Solve:
    def __init__(self, file_name) -> None:
        ...
        self.Board = bd.Board((N, M), board, obstacle)
        time = 10000
        self.listSeen = set()
        self.seeker = self.Board.seeker
        self.hiders = self.Board.hider.copy()
        self.grid = self.Board.grid.copy()
        self.size = (N, M)
    ...
    def debugRender(self):
        renderer = rd2.Render(self.Board, self.history)
        renderer.render()
    ...
    def playLevel1and2(self):
        ...
        while True:
            ...
            self.removeCaught()
             ...
             # Update history
            self.history.append(Info.GameInfo(self.seeker.position, self.createHidersPos(), self.listAnnounce.copy(), self.score, self.step))
